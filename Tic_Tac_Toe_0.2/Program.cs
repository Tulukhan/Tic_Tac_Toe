    ...
    class Program
    {
        ...
        static public void AskPlayer()
        {
            ...
            do
            {
                ...
                isValid = int.TryParse(input, out row);
                if (!isValid || row < 1 || row > 3)
                {
                    Console.WriteLine("Thats Illegal! Invalid row!");
                    continue;
                }
                Console.WriteLine("Collumn:");
                input = Console.ReadLine();
                isValid = int.TryParse(input, out collumn);
                if (!isValid || collumn < 1 || collumn > 3)
                {
                    Console.WriteLine("Thats Illegal! Invalid collumn!");
                    continue;
                }
                ...
                {
                    Console.WriteLine("Thats Illegal! Cell already occupied!");
                }                
            } while (true);
        }
        ...
        {
            /*
            for (int i = 0; i < gametable.GetLength(1); i++) // this looks way better but it would be stupid to use this for 8 of them
            {
                row1 += gametable[0, i];
            }
            */
